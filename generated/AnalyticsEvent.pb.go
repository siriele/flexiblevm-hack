...
type EventMetadata struct {
	...
	// branch for website.
	SourceVersion *string `protobuf:"bytes,2,opt,name=source_version" json:"source_version,omitempty"`
	...
	// it persists
	SessionId *int64 `protobuf:"varint,3,opt,name=session_id" json:"session_id,omitempty"`
	// Per session event counter, to be able to e.g. detect lost events
	EventCounter *int32 `protobuf:"varint,4,opt,name=event_counter" json:"event_counter,omitempty"`
	...
	ProfileId *string `protobuf:"bytes,7,opt,name=profile_id" json:"profile_id,omitempty"`
	...
	ClientTime *int64 `protobuf:"varint,9,opt,name=client_time" json:"client_time,omitempty"`
	// Millisecond Unix timestamp, only populated once the event reaches the server.
	ServerTime       *int64 `protobuf:"varint,10,opt,name=server_time" json:"server_time,omitempty"`
...
type UserProperties struct {
	...
	HaveSetup *bool `protobuf:"varint,1,opt,name=have_setup" json:"have_setup,omitempty"`
	// the last language selected to use on the device
	LastLanguage *string `protobuf:"bytes,2,opt,name=last_language" json:"last_language,omitempty"`
	// whether the user has ever replied yes to having the osmo hardware
	HaveHardware *bool `protobuf:"varint,3,opt,name=have_hardware" json:"have_hardware,omitempty"`
	// whether the user has ever replied yes to having game specific hardware (numbers or coding tiles)
	HaveExtraHardware *bool `protobuf:"varint,4,opt,name=have_extra_hardware" json:"have_extra_hardware,omitempty"`
	// total number of sessions played on this device
	SessionCount *int32 `protobuf:"varint,5,opt,name=session_count" json:"session_count,omitempty"`
	// total playtime on this device
	PlaytimeSec *float32 `protobuf:"fixed32,6,opt,name=playtime_sec" json:"playtime_sec,omitempty"`
	// total time spent in levels in this game
	LeveltimeSec *float32 `protobuf:"fixed32,7,opt,name=leveltime_sec" json:"leveltime_sec,omitempty"`
	// total number of levels started on this device
	LevelStarts *int32 `protobuf:"varint,8,opt,name=level_starts" json:"level_starts,omitempty"`
	// total number of levels whose end was detected, so we can make sure we aren't missing
	// any analytics for in progress levels
	LevelEnds *int32 `protobuf:"varint,9,opt,name=level_ends" json:"level_ends,omitempty"`
	...
	LastMirror *int32 `protobuf:"varint,11,opt,name=last_mirror" json:"last_mirror,omitempty"`
	// last vision debug string for this device
	LastSetupDebug *string `protobuf:"bytes,12,opt,name=last_setup_debug" json:"last_setup_debug,omitempty"`
	// number of times achievements dialog was opened on the device so we can get a sense of
	// how much people care about them
	AchievementsOpened *int32 `protobuf:"varint,13,opt,name=achievements_opened" json:"achievements_opened,omitempty"`
	// last state the game was in when closed on this device so we can get a sense of
	// where people are leaving
	LastState                    *string `protobuf:"bytes,14,opt,name=last_state" json:"last_state,omitempty"`
...
type PlayerState struct {
	...
	AchievementsCompleted        *int32 `protobuf:"varint,1,opt,name=achievements_completed" json:"achievements_completed,omitempty"`
	proto.XXX_InternalExtensions `json:"-"`
	XXX_unrecognized             []byte `json:"-"`
}
...
type SessionEvent struct {
	...
	UserProperties *UserProperties `protobuf:"bytes,2,opt,name=user_properties" json:"user_properties,omitempty"`
	PlayerState    *PlayerState    `protobuf:"bytes,3,opt,name=player_state" json:"player_state,omitempty"`
	// Common game session values aggregated over the session.
	LeveltimeSec                 *float32 `protobuf:"fixed32,4,opt,name=leveltime_sec" json:"leveltime_sec,omitempty"`
	Language                     *string  `protobuf:"bytes,5,opt,name=language" json:"language,omitempty"`
	LastState                    *string  `protobuf:"bytes,6,opt,name=last_state" json:"last_state,omitempty"`
	proto.XXX_InternalExtensions `json:"-"`
	XXX_unrecognized             []byte `json:"-"`
}
...
type LevelEvent struct {
	...
	LevelUniqueId *int64 `protobuf:"varint,1,opt,name=level_unique_id" json:"level_unique_id,omitempty"`
	// identify which level/puzzle they are playing
	LevelId *string `protobuf:"bytes,2,opt,name=level_id" json:"level_id,omitempty"`
...
type ConnectEvent struct {
	...
	UsedInfo         *int32 `protobuf:"varint,2,opt,name=used_info" json:"used_info,omitempty"`
	UsedSkip         *int32 `protobuf:"varint,3,opt,name=used_skip" json:"used_skip,omitempty"`
	NetworkFails     *int32 `protobuf:"varint,4,opt,name=network_fails" json:"network_fails,omitempty"`
	InvalidFails     *int32 `protobuf:"varint,5,opt,name=invalid_fails" json:"invalid_fails,omitempty"`
	UnknownFails     *int32 `protobuf:"varint,6,opt,name=unknown_fails" json:"unknown_fails,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type ClickEvent struct {
	ObjClicked       *string `protobuf:"bytes,1,opt,name=obj_clicked" json:"obj_clicked,omitempty"`
	CurScreen        *string `protobuf:"bytes,2,opt,name=cur_screen" json:"cur_screen,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type SetupEvent struct {
	SetupStatus      *string `protobuf:"bytes,1,opt,name=setup_status" json:"setup_status,omitempty"`
	PaperStatus      *string `protobuf:"bytes,2,opt,name=paper_status" json:"paper_status,omitempty"`
	MirrorQuality    *int32  `protobuf:"varint,3,opt,name=mirror_quality" json:"mirror_quality,omitempty"`
	SetupDebug       *string `protobuf:"bytes,4,opt,name=setup_debug" json:"setup_debug,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type PromoEvent struct {
	PromoKey         *string `protobuf:"bytes,1,opt,name=promo_key" json:"promo_key,omitempty"`
...
type TimedData struct {
	DurationSec      *float32 `protobuf:"fixed32,1,opt,name=duration_sec" json:"duration_sec,omitempty"`
	Completed        *bool    `protobuf:"varint,2,opt,name=completed" json:"completed,omitempty"`
	TimeReadable     *string  `protobuf:"bytes,3,opt,name=time_readable" json:"time_readable,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
...
type Event struct {
	...
	InLevel *InLevelData `protobuf:"bytes,4,opt,name=in_level" json:"in_level,omitempty"`
	...
	ProfileEdit                  *ProfileEditEvent   `protobuf:"bytes,103,opt,name=profile_edit" json:"profile_edit,omitempty"`
	Promo                        *PromoEvent         `protobuf:"bytes,104,opt,name=promo" json:"promo,omitempty"`
	XAppShow                     *CrossAppShowEvent  `protobuf:"bytes,105,opt,name=x_app_show" json:"x_app_show,omitempty"`
	XAppClick                    *CrossAppClickEvent `protobuf:"bytes,106,opt,name=x_app_click" json:"x_app_click,omitempty"`
	StateChange                  *StateChangeEvent   `protobuf:"bytes,107,opt,name=state_change" json:"state_change,omitempty"`
	proto.XXX_InternalExtensions `json:"-"`
	XXX_unrecognized             []byte `json:"-"`
}
...
type EventBatch struct {
	// Millisecond Unix timestamp.
	ClientSendTime   *int64   `protobuf:"varint,1,opt,name=client_send_time" json:"client_send_time,omitempty"`
...
var fileDescriptor0 = []byte{
	...
	,
}
